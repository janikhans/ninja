...
class BlocksControllerTest < ActionController::TestCase
  ...
  test "should create block" do
    assert_difference('Block.count') do
      post :create, block: { beginning: @block.beginning, category: @block.category, end: @block.end, user_id: @block.user_id }
    end
  ...
  test "should update block" do
    patch :update, id: @block, block: { beginning: @block.beginning, category: @block.category, end: @block.end, user_id: @block.user_id }
    assert_redirected_to block_path(assigns(:block))
  end
